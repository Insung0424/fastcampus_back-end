...
public class MovieDAO {
	...
	private void init() {
		...
		list.add(new Movie("라라랜드", 1000, 5,"황홀한 사랑, 순수한 희망, 격렬한 열정... "
	...
	public void addReserveInfo(MyMovie myMovie) {
		reserveList.add(new MyMovie(myMovie.getmName(),
				myMovie.getTime(), myMovie.getSeat()));
	}
