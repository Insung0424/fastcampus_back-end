...
//	}
	...
	private void initialize() {
		...
		lblPassword_1.setFont(new Font("휴먼모음T", Font.PLAIN, 20));
		...
		emailLB.setFont(new Font("휴먼모음T", Font.PLAIN, 20));
		...
		GenderLB.setFont(new Font("휴먼모음T", Font.PLAIN, 20));
		...
		Registerbtn.setFont(new Font("휴먼모음T", Font.PLAIN, 20));
               ...
               JOptionPane.showMessageDialog(null, "비밀번호는 영문+숫자 4자 이상로 구성되어야 합니다", "비밀번호 오류", 1);
				...
				try {
					Connection conn = LottoLogin.getConnection();
	                  ...
	                  pstmt.setString(6, emailTf.getText());
